...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, token_positions: torch.Tensor | None = None) -> torch.Tensor:
        ...
        mult_head_attention = rearrange(SPDA(hQ, hK, hV, mask), "... n_heads seq d_head -> ... seq (n_heads d_head)")
        return einsum(mult_head_attention, self.WO, "... d_v, ... d_model d_v -> ... d_model")
